...
exports.fSearchGiphys = exports.receiveSearchGiphys = exports.REQUEST_SEARCH_GIPHYS = exports.RECEIVE_SEARCH_GIPHYS = undefined;
...
var fSearchGiphys = exports.fSearchGiphys = function fSearchGiphys(searchTerm) {
...
var GiphysSearch = function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function componentDidMount() {
      this.props.fSearchGiphys('golden+retriever');
    }
  }, {
    key: 'handleChange',
    ...
    value: function handleSubmit(e) {
      ...
      this.props.fSearchGiphys(searchTerm);
    }
  }, {
    key: 'render',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return { fSearchGiphys: function fSearchGiphys(searchTerm) {
            return dispatch((0, _giphy_actions.fSearchGiphys)(searchTerm));
        } };
};
...
exports.REQUEST_SEARCH_GIPHYS = undefined;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.store = store;
    window.fSearchGiphys = _giphy_actions.fSearchGiphys;
